		...
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!email.endsWith("@gmail.com")) {
		            JOptionPane.showMessageDialog(AddStudent.this, "Invalid Email! Email must end with @gmail.com");
		            return;
		        }

		        // Contact Number Validation: Must be exactly 10 digits and contain only numbers
		        if (!contactno.matches("\\d{10}")) {
		            JOptionPane.showMessageDialog(AddStudent.this, "Invalid Contact Number! It must be exactly 10 digits and contain only numbers.");
		            return;
		        }
		        
		        /*
		        if (contactno.length() != 10) {
				    JOptionPane.showMessageDialog(AddStudent.this, "Invalid Contact Number! It must be exactly 10 digits.");
				    return;
				}
				
				for (int i = 0; i < contactno.length(); i++) {
				    if (!Character.isDigit(contactno.charAt(i))) {
				        JOptionPane.showMessageDialog(AddStudent.this, "Invalid Contact Number! It must contain only digits.");
				        return;
				    }
				}
