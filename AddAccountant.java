			...
			public void actionPerformed(ActionEvent e) {
				...
				String contactno=textField_2.getText();
				 ...
				 if (!email.endsWith("@gmail.com")) {
			            JOptionPane.showMessageDialog(AddAccountant.this, "Invalid Email! Email must contain @gmail.com");
			            return;
			        }

			        // Contact Number Validation: Must be exactly 10 digits
				 if (!contactno.matches("\\d{10}")) {
					    JOptionPane.showMessageDialog(AddAccountant.this, "Invalid Contact Number! It must be exactly 10 digits and contain only numbers.");
					    return;
					}
